...
class Started implements SplashEvent {
  const Started();
...
mixin _$SplashState {
 ...
 bool get isLoading; bool get isError; String get message; bool get done;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isError, isError) || other.isError == isError)&&(identical(other.message, message) || other.message == message)&&(identical(other.done, done) || other.done == done));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,isError,message,done);

@override
String toString() {
  return 'SplashState(isLoading: $isLoading, isError: $isError, message: $message, done: $done)';
}
...
@useResult
$Res call({
 bool isLoading, bool isError, String message, bool done
});
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? isError = null,Object? message = null,Object? done = null,}) {
...
class _SplashState implements SplashState {
  const _SplashState({this.isLoading = false, this.isError = false, this.message = '', this.done = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SplashState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isError, isError) || other.isError == isError)&&(identical(other.message, message) || other.message == message)&&(identical(other.done, done) || other.done == done));
}
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? isError = null,Object? message = null,Object? done = null,}) {
