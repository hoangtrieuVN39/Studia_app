...
// in studia/test/skills/domain/fetch_levels_usecase_test.dart.
...
import 'package:studia/core/data/datasources/local/drift/database.dart' as _i2;
...
class _Fake$StandardsTableTable_0 extends _i1.SmartFake
    implements _i2.$StandardsTableTable {
  _Fake$StandardsTableTable_0(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$DomainsTableTable_1 extends _i1.SmartFake
    implements _i2.$DomainsTableTable {
  _Fake$DomainsTableTable_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$SkillsTableTable_2 extends _i1.SmartFake
    implements _i2.$SkillsTableTable {
  _Fake$SkillsTableTable_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$LevelsTableTable_3 extends _i1.SmartFake
    implements _i2.$LevelsTableTable {
  _Fake$LevelsTableTable_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockAppDatabase extends _i1.Mock implements _i2.AppDatabase {
  ...
  @override
  _i2.$StandardsTableTable get standardsTable =>
      (super.noSuchMethod(
            Invocation.getter(#standardsTable),
            returnValue: _Fake$StandardsTableTable_0(
              this,
              Invocation.getter(#standardsTable),
            ),
            returnValueForMissingStub: _Fake$StandardsTableTable_0(
              this,
              Invocation.getter(#standardsTable),
            ),
          )
          as _i2.$StandardsTableTable);

  @override
  _i2.$DomainsTableTable get domainsTable =>
      (super.noSuchMethod(
            Invocation.getter(#domainsTable),
            returnValue: _Fake$DomainsTableTable_1(
              this,
              Invocation.getter(#domainsTable),
            ),
            returnValueForMissingStub: _Fake$DomainsTableTable_1(
              this,
              Invocation.getter(#domainsTable),
            ),
          )
          as _i2.$DomainsTableTable);

  @override
  _i2.$SkillsTableTable get skillsTable =>
      (super.noSuchMethod(
            Invocation.getter(#skillsTable),
            returnValue: _Fake$SkillsTableTable_2(
              this,
              Invocation.getter(#skillsTable),
            ),
            returnValueForMissingStub: _Fake$SkillsTableTable_2(
              this,
              Invocation.getter(#skillsTable),
            ),
          )
          as _i2.$SkillsTableTable);

  @override
  _i2.$LevelsTableTable get levelsTable =>
      (super.noSuchMethod(
            Invocation.getter(#levelsTable),
            returnValue: _Fake$LevelsTableTable_3(
              this,
              Invocation.getter(#levelsTable),
            ),
            returnValueForMissingStub: _Fake$LevelsTableTable_3(
              this,
              Invocation.getter(#levelsTable),
            ),
          )
          as _i2.$LevelsTableTable);
  ...
  _i5.Future<List<_i2.Standards>> selectStandards({
    ...
    int? skill,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i5.Future<List<_i2.Standards>>.value(
              <_i2.Standards>[],
            ),
            returnValueForMissingStub: _i5.Future<List<_i2.Standards>>.value(
              <_i2.Standards>[],
            ),
          )
  ...
  _i5.Future<List<_i2.Domains>> selectDomains() =>
      (super.noSuchMethod(
            ...
            returnValueForMissingStub: _i5.Future<List<_i2.Domains>>.value(
              <_i2.Domains>[],
            ),
          )
  ...
  @override
  _i5.Future<List<_i2.Skills>> selectSkills({
    int? skill_id,
    int? domain,
    int? level,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#selectSkills, [], {
              #skill_id: skill_id,
              #domain: domain,
              #level: level,
            }),
            returnValue: _i5.Future<List<_i2.Skills>>.value(<_i2.Skills>[]),
            returnValueForMissingStub: _i5.Future<List<_i2.Skills>>.value(
              <_i2.Skills>[],
            ),
          )
          as _i5.Future<List<_i2.Skills>>);

  @override
  _i5.Future<List<_i2.Levels>> selectLevels({int? id}) =>
      (super.noSuchMethod(
            Invocation.method(#selectLevels, [], {#id: id}),
            returnValue: _i5.Future<List<_i2.Levels>>.value(<_i2.Levels>[]),
            returnValueForMissingStub: _i5.Future<List<_i2.Levels>>.value(
              <_i2.Levels>[],
            ),
          )
